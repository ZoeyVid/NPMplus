...
COPY --from=zoeyvid/valkey-static:48 /usr/local/bin/valkey-cli    /usr/local/bin/valkey-cli
COPY --from=zoeyvid/valkey-static:48 /usr/local/bin/valkey-server /usr/local/bin/valkey-server
