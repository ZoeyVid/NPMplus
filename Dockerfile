...
COPY --from=zoeyvid/valkey-static:68 /usr/local/bin/valkey-cli    /usr/local/bin/valkey-cli
COPY --from=zoeyvid/valkey-static:68 /usr/local/bin/valkey-server /usr/local/bin/valkey-server
